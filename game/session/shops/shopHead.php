    ...
    if($connect -> connect_errno != false) {
        ...
        if($_SESSION['transaction']){
            if(isset($_SESSION['choice'])){
                ...
                $sql = "SELECT * FROM armourbody WHERE id='$value'";
                if($result = @$connect->query($sql)){
                    $record = $result->fetch_assoc();
                    $_SESSION['headName'] = $record['name'];
                    $_SESSION['headId'] = $_SESSION['choseId'];
                    $_SESSION['armourHeadProtection'] = $record['protection'];
            ...
            <div class="image">
                ...
                if(isset($_SESSION['confirm']) and $_SESSION['confirm']){
                    switch ($_SESSION['choice']){
                        ...
                        case 2:{
                            echo('<input type="image" src="'.$imageLocation[2].'" width=
                            "122" height="122">');
                            break;
                        }
                        case 3:{
